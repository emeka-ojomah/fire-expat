...
export default function Register({ setIsAuthenticated }) {
  ...
  return (
    <div className="min-h-screen bg-[#0B1220] flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-[420px] bg-[#151E31] border border-slate-800 rounded-2xl p-6 sm:p-8">
        {/* Brand */}
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div>
            ...
            {password.length > 0 && password.length < 6 && (
              <p className="text-[11px] text-red-400 mt-1.5">Password must be at least 6 characters</p>
            )}
          </div>
