        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 4, right: 8, left: 0, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="target" name="FIRE Target" stroke="#4F46E5" strokeWidth={1.5} strokeDasharray="4 4" fill="url(#targetGradient)" />
              <Area type="monotone" dataKey="savings" name="Projected Net Worth" stroke="#0EA5E9" strokeWidth={2.5} fill="url(#savingsGradient)" />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      )}
